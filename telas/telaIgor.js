  ...
  useEffect(() => {
    fetch('https://dados.ufrn.br/api/action/datastore_search?resource_id=ff0a457e-76fa-4aca-ad99-48aebd7db070&limit=20000')
      ...
      .then(data => {
        ...
        const nomeProcurado = 'IGOR ROSBERG DE MEDEIROS SILVA';
    ...
    <View style={styles.container}>
      ...
      {professor ? (
        <View style={styles.card}>
          ...
          <Text style={styles.nota}>Desvio Padrão Geral: 1.79</Text>
          <Text style={styles.nota}>Média Geral: 9.61</Text>
        </View>
      ) : (
