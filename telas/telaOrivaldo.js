  ...
  useEffect(() => {
    fetch('https://dados.ufrn.br/api/action/datastore_search?resource_id=ff0a457e-76fa-4aca-ad99-48aebd7db070&limit=20000')
      ...
      .then(data => {
        ...
        const nomeProcurado = 'ORIVALDO VIEIRA DE SANTANA JUNIOR';
    ...
    <View style={styles.container}>
      ...
      {professor ? (
        <View style={styles.card}>
          ...
          <Text style={styles.nota}>Desvio Padrão Geral: 1.41</Text>
          <Text style={styles.nota}>Média Geral: 9.82</Text>
          <Text></Text>
        </View>
      ) : (
